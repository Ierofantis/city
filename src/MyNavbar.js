                    ...
                    <Navbar  bg="dark" variant="dark" expand="lg">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                          <Nav className="mr-auto">
                            ...
                            { renderNavbar ? (<Nav.Link  style = {{color: "#F0431E"} }className="nav navbar-nav navbar-right" onClick={() => this.Subscribe()}>Notify Me!</Nav.Link>):<Nav.Link  className="nav navbar-nav navbar-right" disabled>Notify Me!</Nav.Link>}
                          </Nav>
                        </Navbar.Collapse>
                      </Navbar>
